...
-------------------------------------------------------
The script will create 4 Home Assistant sensors, by the name you choose (in sensor_name, as exemplified here, the value is ‘red_alert’):
...
class Red_Alerts_Israel(Hass):
    ...
    def check_data(self, data):
        ...
        sensor_attributes={"id": alert_c_id,"cat": category,"alert": text_status,"alert_alt": full_message_str,"alert_txt": full_message_txt,"alert_wa": text_wa,"alert_tg": text_tg, "title": alert_title,"desc": descr,"areas": areas_alert,"data": alerts_data,"data_count": data_count,"duration": duration,"icon": icon_alert,"emoji":  icon_emoji,"last_changed": datetime.now().isoformat(),"prev_cat": category,"prev_title": alert_title,"prev_desc": descr,"prev_areas": areas_alert,"prev_data": alerts_data,"prev_data_count": data_count,"prev_duration": duration,"prev_last_changed": datetime.now().isoformat(),}
